...
<section
   className="relative z-10 overflow-hidden bg-white py-20 px-5  lg:py-[80px] lg:w-11/12 h-auto mt-28"
   >
      ...
      <div className="flex flex-wrap -mx-4 lg:justify-between">
         <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div className="mb-12 max-w-[570px] lg:mb-0">
               ...
               <h2
                  className="text-black mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]"
                  >
                  Contact Us
               </h2>
               <p
                  className="text-lg leading-relaxed text-body-color mb-9"
                  >
               ...
               <div className="mb-8 flex w-full max-w-[370px]">
                  <div
                     className=" text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded sm:h-[70px] sm:max-w-[70px]"
                     >
                     <img src="/image/1865269.png" alt="" />
                  </div>
                  <div className="w-full">
                     ...
                     <p className="text-base text-body-color">
                        R/Balangoda Ananda Maithreya Central College, Miriswaththa, Balangoda
                     </p>
                  </div>
               </div>
               <div className="mb-8 flex w-full max-w-[370px]">
         ...
         <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
            <div
               className="relative p-8 bg-[#691411] rounded-lg shadow-lg sm:p-12"
               >
               <form>
                  <div className="mb-6">
                     <input
                  ...
                  <div>
                     <button
                        type="submit"
                        className="w-full p-3 text-white text-xl transition border rounded border-primary bg-[#3A0F09] hover:bg-opacity-120"
                        >
                     Send Message
                     </button>
                  </div>
               ...
               <div>
                  <span className="absolute -top-16 -right-14 z-[20]">
